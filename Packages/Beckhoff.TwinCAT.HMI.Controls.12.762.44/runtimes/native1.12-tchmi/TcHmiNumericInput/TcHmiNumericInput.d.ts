declare module TcHmi.Controls.Beckhoff {
    class TcHmiNumericInput extends TcHmi.Controls.System.TcHmiControl {
         ...
         * @param valueNew The new value for value
         */
        protected __setValue(valueNew: number | null | undefined, options?: {
            process?: boolean;
            fromInput?: boolean;
        }): void;
        /**
         ...
         */
        setMinValue(valueNew: number | null | undefined): void;
        /**
         ...
         */
        setMaxValue(valueNew: number | null | undefined): void;
        /**
